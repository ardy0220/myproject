package com.ttg.utils.filedownload;
...
public class DownloadManager implements Runnable {
	...
	private static final Log logger = LogFactory.getLog(DownloadManager.class);
	// 保存路径
	...
	public long getFileLength() {
		...
		logger.debug("获得文件大小  end......" + result);
		return result;
	}
